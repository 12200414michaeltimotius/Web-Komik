                    ...
                    <form class="form-horizontal form-material" id="loginform" action="index.html">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">Setuju <a href="javascript:void(0)">Terms</a></label> 
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Sudah punya akun? <a href="pages-login.html" class="text-info m-l-5"><b>Login</b></a>
                            </div>
                        </div>
                    </form>
                </div>
